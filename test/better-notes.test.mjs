...
async function fixture() {
  ...
  const Zotero = {PreferencePanes:{register:async()=> 'preferences',unregister:()=>{}},Notifier:{registerObserver:()=>1,unregisterObserver:()=>{}},BetterNotes:{api,hooks:{onOpenNote:async()=>{active=true;},onSyncing:async()=>{
    if(failSync)return;
